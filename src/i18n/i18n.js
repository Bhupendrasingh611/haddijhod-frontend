...
const resources = {
  en: {
    translation: {
      ...
      heroText:
        "Trusted herbal powder helping bone strength and recovery for the last 12 years.",
      price: "Only ₹350",
    ...
    herbalDesc: "Natural powder-based support made with traditional herbal care.",
    priceTitle: "Affordable Price",
    priceDesc: "Professional quality support available at only ₹299.",
...
productText: "Traditional herbal powder designed to support fracture recovery, bone strength, and better healing support with trusted care.",
...
whatsappLabel: "WhatsApp",
  ...
  hi: {
    translation: {
      ...
      heroText:
        "12 वर्षों से भरोसेमंद हर्बल पाउडर जो हड्डियों की मजबूती और रिकवरी में सहायता करता है।",
   price: "केवल ₹350",
    ...
    herbalDesc: "प्राकृतिक पाउडर आधारित पारंपरिक हर्बल सहायता।",
    priceTitle: "किफायती कीमत",
    priceDesc: "केवल ₹299 में भरोसेमंद गुणवत्ता।",
    easyTitle: "आसान ऑर्डर",
    easyDesc: "WhatsApp और फोन के माध्यम से आसान ऑर्डर सुविधा।",

productTitle: "हड्डी जोड़ हर्बल दवाई",
productText: "पारंपरिक हर्बल पाउडर जो फ्रैक्चर रिकवरी, हड्डियों की मजबूती और बेहतर उपचार में सहायता करता है।",
